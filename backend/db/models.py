...
class ChatbotConfig(Base):
    ...
    personality_tone: Mapped[str] = mapped_column(String(50), default="ramah")
    token_cost: Mapped[int] = mapped_column(Integer, default=2)
...
class ChatSession(Base):
    ...
    user_identifier: Mapped[str] = mapped_column(String(200))
